...
@WebServlet("/yc")
public class YellowChilli extends HttpServlet{


    private static Logger logger = LoggerFactory.getLogger(YellowChilli.class);
            ...
            if(cid>0) {
                ...
                if (idType != null && idType.matches("devid|gid") && id != null && !"".equals(id.trim())) {
                    ...
                    if (resp != null && !"".equals(resp.trim()) && !"Read timed out".equals(resp.trim())) {
                        ...
                        response.sendRedirect("./yellowchilli");
                    } else {
